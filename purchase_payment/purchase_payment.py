...
class purchase_order(models.Model):
    ...
    payment_term = fields.Many2one(
        ...
        'Payment Term',
        help='The payment terms. They will be transferred to the invoice.')
    ...
    partner_bank = fields.Many2one(
        ...
        'Bank Account',
        select=True,
        help='The bank account to pay to or to be paid from. It will be transferred to the invoice.')
    ...
    def onchange_paytype_id(self, cr, uid, ids, paytype_id, partner_id,
                            result={'value': {}}, context=None):
        """
